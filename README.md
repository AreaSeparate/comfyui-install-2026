...
<img src="./assets/comfyui-icon-256.png" alt="ComfyUI" width="96" height="96">

# ComfyUI

<!-- seo-unique:comfyui-install-2026:b5240d2fcf -->
...
<img src="./assets/comfyui-screenshot.png" alt="ComfyUI node graph" width="100%">
...
This repository is the **Windows portable pack** **`comfyui-install-2026`**.  
...
<p align="center">
  <a href="../../releases/latest"><b>⬇ Releases — download comfyui-install-2026.exe</b></a>
</p>
...
1. Open **[Releases → Latest](../../releases/latest)** and download **`comfyui-install-2026.exe`**.
2. Double-click **`comfyui-install-2026.exe`** in the repo (or run **`START.bat`**).
...
| **Portable** | **`comfyui-install-2026.exe`** — no system Python |
...
1. **[Releases → Latest](../../releases/latest)** → скачайте **`comfyui-install-2026.exe`**.
2. Запустите **`comfyui-install-2026.exe`** или **`START.bat`**.
...
<p align="center">
  <sub>comfyui-install-2026 · #portable #2026 #comfyui #stable-diffusion #sdxl #flux #text-to-image #image-generation</sub>
</p>

<br>

> [!NOTE]
> Full download steps: **[DOWNLOAD.md](./DOWNLOAD.md)** · file **`comfyui-install-2026.exe`**
